...
/*
 * function definitions. All these definitions must be written according to
 * ANSI definition. The user will transform them, one by one, according his
 * need.
 */
...
extern void	poly();
extern void	polf();
extern	void	pmv(float, float, float);
extern void	pmvi();
extern void	pmv2i();
extern void	pmvs();
extern void	pmv2s();
